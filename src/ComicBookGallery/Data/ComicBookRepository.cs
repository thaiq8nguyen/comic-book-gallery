...
namespace ComicBookGallery.Data
{
    ...
    {
        private static ComicBook[] _comicBooks = new Models.ComicBook[]
        {
            new ComicBook()
            {
                ID = 1,
                ...
                "life and his one, last, great act of revenge! Even if Spider-Man survives... <strong>will Peter Parker?</strong>",
                Artists = new Artist[]
                {
            ...
            new ComicBook()
            {
                ...
                "Spider-Man visits the FF for a very private wake--just for family.</p>",
                Artists = new Artist[]
                {
                    new Artist() { Name = "Dan Slott", Role = "Script" },
            ...
            new ComicBook()
            {
                ...
                "Thorn is discovered by Lord Tarsil and the corrupted Stickeaters and thrown into a dungeon with Fone Bone. As she sleeps, a message comes to her about the mysterious \"Crown of Horns\".</p>",
                Artists = new Artist[]
                {
